...
import { CreditCardIcon, BuildingLibraryIcon, ShieldCheckIcon, CheckCircleIcon } from '@heroicons/react/24/outline';
...
const CheckoutPage = () => {
  ...
  const shippingCost = shippingMethod === 'standard' ? (cartTotal >= 999 ? 0 : 99) : 199;
  ...
  const validateForm = () => {
    ...
    if (currentStep === 1) {
      ...
      else if (!/^\d{10}$/.test(formData.phone.replace(/[^0-9]/g, ''))) newErrors.phone = 'Phone number must be 10 digits';
      if (!formData.address.trim()) newErrors.address = 'Address is required';
      if (!formData.city.trim()) newErrors.city = 'City is required';
      if (!formData.state.trim()) newErrors.state = 'State is required';
      if (!formData.pincode.trim()) newErrors.pincode = 'Pincode is required';
      else if (!/^\d{6}$/.test(formData.pincode.replace(/[^0-9]/g, ''))) newErrors.pincode = 'Pincode must be 6 digits';
    }
    ...
    if (currentStep === 2 && paymentMethod === 'card') {
      ...
      else if (!/^\d{16}$/.test(formData.cardNumber.replace(/[^0-9]/g, ''))) newErrors.cardNumber = 'Card number must be 16 digits';
      if (!formData.expiryDate.trim()) newErrors.expiryDate = 'Expiry date is required';
      else if (!/^(0[1-9]|1[0-2])\/\d{2}$/.test(formData.expiryDate)) newErrors.expiryDate = 'Expiry date format must be MM/YY';
      ...
      case 1:
        return (
          <div className="space-y-6">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mt-8">Shipping Information</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-800 mt-8">Shipping Method</h3>
            
            <div className="space-y-4">
              <div className={`border rounded-md p-4 cursor-pointer ${
                shippingMethod === 'standard' ? 'border-primary bg-primary/5' : 'border-gray-300'
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3 flex-1">
                    <label htmlFor="standard" className="font-medium text-gray-800 block">Standard Shipping</label>
                    <p className="text-gray-500 text-sm">Delivery in 3-5 business days</p>
                  </div>
                  <div className="text-right">
                    <span className="font-medium">{cartTotal >= 999 ? 'Free' : '₹99'}</span>
                  </div>
                </div>
              </div>
              
              <div className={`border rounded-md p-4 cursor-pointer ${
                shippingMethod === 'express' ? 'border-primary bg-primary/5' : 'border-gray-300'
                ...
                <div className="flex items-center">
                  ...
                  />
                  <div className="ml-3 flex-1">
                    <label htmlFor="express" className="font-medium text-gray-800 block">Express Shipping</label>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="upi" className="ml-3 flex items-center">
                    <svg className="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M6 12.5L10 16.5L18 8.5" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
              ...
              <div className={`border rounded-md p-4 cursor-pointer ${
                paymentMethod === 'netbanking' ? 'border-primary bg-primary/5' : 'border-gray-300'
            ...
            {paymentMethod === 'card' && (
              <div className="mt-6 space-y-6 border-t border-gray-200 pt-6">
                <h4 className="text-base font-medium text-gray-800">Card Details</h4>
            ...
            {paymentMethod === 'upi' && (
              <div className="mt-6 space-y-6 border-t border-gray-200 pt-6">
                <h4 className="text-base font-medium text-gray-800">UPI Details</h4>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-600">Your payment info is secure and encrypted</span>
                </div>
              </div>
            )}
            ...
            {paymentMethod === 'netbanking' && (
              <div className="mt-6 space-y-6 border-t border-gray-200 pt-6">
                <h4 className="text-base font-medium text-gray-800">Select Bank</h4>
                ...
                <div>
                  <label htmlFor="otherBank" className="block text-sm font-medium text-gray-700 mb-1">
                    Other Banks
                  </label>
                  <select
                    name="otherBank"
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              <h4 className="text-base font-medium text-gray-800 mb-3">Shipping Information</h4>
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    <span className="font-medium">State:</span> {formData.state}, {formData.pincode}
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Payment Method */}
            <div className="bg-gray-50 p-4 rounded-md">
              <h4 className="text-base font-medium text-gray-800 mb-3">Payment Method</h4>
              <p className="text-gray-600 text-sm">
                {paymentMethod === 'card' && (
                  <>
            ...
            {/* Billing Summary */}
            <div className="bg-gray-50 p-4 rounded-md">
              <h4 className="text-base font-medium text-gray-800 mb-3">Order Summary</h4>
                ...
                {['Shipping', 'Payment', 'Review'].map((step, index) => (
                  <div key={step} className="flex flex-col items-center flex-1">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium mb-2 ${
                      ...
                      currentStep === index + 1 ? 'bg-primary text-white' : 'bg-gray-200 text-gray-700'
                    }`}>
                      {currentStep > index + 1 ? (

...
import { EyeIcon, EyeSlashIcon, CheckCircleIcon, XCircleIcon, ArrowLeftIcon, UserPlusIcon } from '@heroicons/react/24/outline';
...
const SignupPage = () => {
  ...
  // Validate form (same as your current code)

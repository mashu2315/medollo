...
// //             className="w-full bg-primary text-white py-2 rounded-lg hover:bg-primary/90 transition-all font-semibold">
// //               Add to Cart
// //             </button>
// //             <button 
// //               onClick={() => {
...
// //       navigate("/cart");
// //     }}
// //             className="w-full bg-secondary text-white py-2 rounded-lg hover:bg-secondary/90 transition-all font-semibold">
// //               Order Now
// //             </button>
// //           </div>
// //         </div>
...
// //           <p>
// //             <strong>Brand:</strong> {details.brand_name || "N/A"}
// //           </p>
// //           <p>
// //             <strong>Manufacturer:</strong> {details.manufacturer || "N/A"}
// //           </p>
// //           <p>
// //             <strong>Pack Size / Per Unit:</strong> {details.perUnit || "N/A"}
// //           </p>
// //           <p>
// //             <strong>Composition:</strong>{" "}
// //             <span className="italic">{details.composition || "N/A"}</span>
// //           </p>
// //           <p>
...
// //             <p>
// //               <strong>MRP:</strong>{" "}
// //               <span className="text-red-600 line-through">{details.mrp || "N/A"}</span>
// //             </p>
// //             <p>
// //               <strong>Regular Price:</strong>{" "}
// //               <span className="text-green-700 font-bold">{details.regularPrice || "N/A"}</span>
// //             </p>
// //             <p>
// //               <strong>Member Price:</strong>{" "}
// //               <span className="text-primary font-bold">{details.memberPrice || "N/A"}</span>
// //             </p>
// //           </div>
// //         </div>
// //       </div>
...
// //                   src={
// //                     item.image_url ||
// //                     "https://placehold.co/120x120/F3F4F6/6B7280?text=No+Image"
// //                   }
...
// //                     e.target.onerror = null;
// //                     e.target.src =
// //                       "https://placehold.co/120x120/FEE2E2/DC2626?text=No+Image";
// //                   }}
// //                 />
...
// //                     MRP: <span className="font-medium">₹{item.mrp}</span>
// //                   </p>
// //                 )}
// //               </a>
// //             ))}
...
//   const navigate = useNavigate();
//   const { selectedMedicine } = useMedicine();
//   const { addToCart, isLoggedIn } = useCart(); // ✅ get isLoggedIn from context
...
//       navigate("/login", {
//         state: {
//           from: `/medicine/${details._id || details.name}`,
...
//                 {details.regularPrice || "N/A"}
//               </span>
//             </p>
//             <p>
//               <strong>Member Price:</strong>{" "}
//               <span className="text-primary font-bold">
//                 {details.memberPrice || "N/A"}
//               </span>
//             </p>
//           </div>
//         </div>
